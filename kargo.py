...
# Assumes standard Kubernetes naming conventions (plural file, singular kind).
schema_mapping = {
...
for url, kind in schema_mapping.items():
    ...
    if response.status_code == 200:
        ...
        # Wrap the schema with an if/then block that checks for the correct 'kind'.
        wrapped = {
...
composite_schema = {"oneOf": wrapped_schemas}
